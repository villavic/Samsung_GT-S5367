...
#if defined(CONFIG_LTN_COMMON) //[latin_protocol] skh call end reason
static Cause_t   mnLastCallFailCause = 0;
#endif
...
//******************************************************************************
//
// Function Name: KRIL_SetMnLastCallFailCause
//
// Description:   Set the last call failure cause.
//
// Notes:
//
//******************************************************************************
void KRIL_SetMnLastCallFailCause(Cause_t inCause)
{
    KRIL_DEBUG(DBG_INFO,"SetSetMnLastCallFailCause:%d\n", inCause);
    mnLastCallFailCause = inCause;

}

//******************************************************************************
//
// Function Name: KRIL_GetMnLastCallFailCause
//
// Description:   Get the last call failure cause.
//
// Notes:
//
//******************************************************************************
Cause_t KRIL_GetMnLastCallFailCause(void)
{
    KRIL_DEBUG(DBG_INFO,"mnLastCallFailCause:%d\n", mnLastCallFailCause);
    return mnLastCallFailCause;
}
