...
CAM_Sensor_Supported_Params_t CamPrimaryDefault_st =
{
	...
	"SAMSUNG",
#if defined(CONFIG_LUISA_L_LTN_COMMON)	// [LTN_SW3_MMI_MM] sj23.ahn 2011.07.07 : Support latin camera Exif model name.
	"GT-B5510L" //target name
#elif defined(CONFIG_LUISA_B_LTN_COMMON)
	"GT-B5510B" //target name
#else
