...
//+ [LTN_SW3_SYSTEM] inseok.jeong 2011.9.7 : S/W Engineering Group 2 requested that the default IMEI number is displayed to 000000-00-000000.
#if defined(CONFIG_LUISA_LTN_COMMON)
		bIMEIError = FALSE;
#else
		bIMEIError = TRUE;
#endif
