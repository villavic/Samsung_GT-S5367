...
/* Vip-NET GSM d.o.o. */
{ 219,  10, NETWK_TYPE_GSM_900, "HR-VIP", "HR-VIP" },//[2009.01.21]sun.mi.jung �һ��缭�� PLMN name��� ���.
 ...
 *********************/
/* Swisscom Mobile Ltd */
{ 228,   1, NETWK_TYPE_GSM_900, "Swisscom", "Swisscom" },//[2007.09.19]wonki.ha ������ ��û�� ���� �ҹ��ڷ� ���
/* Swisscom Mobile Ltd */
{ 228,   1, NETWK_TYPE_DCS_1800, "Swisscom", "Swisscom" },//[2007.09.19]wonki.ha ������ ��û�� ���� �ҹ��ڷ� ���
/* TDC Switzerland AG */
{ 228,   2, NETWK_TYPE_GSM_900, "Sunrise", "Sunrise" }, //2008.12.02 sunrise->Sunrise ��ä��Yves Piccand [y.piccand@samsung.com] ��û����
/* TDC Switzerland AG */
{ 228,   2, NETWK_TYPE_DCS_1800, "Sunrise", "Sunrise" }, //2008.12.02 sunrise->Sunrise ��ä��Yves Piccand [y.piccand@samsung.com] ��û����
/* Orange Communications S.A */
{ 228,   3, NETWK_TYPE_DCS_1800, "orange CH", "orange CH" },//[2007.09.19]wonki.ha ������ ��û�� ���� �빮�ڷ�  ���
/* In &Phone SA */
...
/* Connect Austria */
{ 232,   12, NETWK_TYPE_GSM_900, "Orange A", "Orange AT" },// D0100306029 2011/9/16 Orange ������ ��û
/* Connect Austria */
{ 232,   12, NETWK_TYPE_DCS_1800, "Orange A", "Orange AT" },// D0100306029 2011/9/16 Orange ������ ��û
/* Connect Austria */
{ 232,   12, NETWK_TYPE_UMTS, "Orange A", "Orange AT" },// D0100306029 2011/9/16 Orange ������ ��û
...
/* Tele 2 AB */
{ 240,   7, NETWK_TYPE_GSM_900, "Tele2comviq", "Tele2comviq" },   //2008.12.02 S COMVIQ-> Tele2comviq ��ä��Andreas Bergqvist [andreas.bergqvist@samsung.se] ��û
/* Tele 2 AB */
...
/* VOXmobile S.A. */
{ 270, 99, NETWK_TYPE_DCS_1800, "Orange", "Orange" }, //2008.12.02 VOX.LU -> Vox Mobile ��ä�� Loris Beerten [l.beerten@samsung.com]��û����  
/* VOXmobile S.A. */
{ 270, 99, NETWK_TYPE_UMTS, "Orange", "Orange" },     //2008.12.02 VOX.LU -> Vox Mobile ��ä�� Loris Beerten [l.beerten@samsung.com]��û����  
...
/* Areeba LTD */
{ 280, 10, NETWK_TYPE_GSM_900, "MTN", "MTN" }, //2008.12.02 Areeba-> MTN ��ä�ο�û Polys Hadjikyriakos 
/* Areeba LTD */
 ...
 ****************/
/* TR Turkcell */
{ 286,   1, NETWK_TYPE_GSM_900, "TR Turkcell", "TR Turkcell" }, // 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
/* VODAFONE TR */
{ 286,   2, NETWK_TYPE_GSM_900, "VODAFONE TR", "VODAFONE TR" },// 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
/* IS-TIM Telekomunikasyon Hizmetleri Anonim Sirketi */
{ 286,   3, NETWK_TYPE_DCS_1800, "TR AVEA", "TR AVEA" }, // 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
...
{ 334,  30, NETWK_TYPE_PCS_1900, "movistar", "movistar" }, // 2009.09.01 �߳��� ���� �׷� �Ⱥ��� ���� ��û
#if defined (CONFIG_LTN_COMMON)
...
{ 342,  81, NETWK_TYPE_GSM_900, "AT&T Wireless", "AT&T Wireless" }, // 2009.09.09 �߳��� ���� �׷� �Ⱥ��� ���� ��û
#if defined (CONFIG_LTN_COMMON) 
/* Cable & Wireless Barbados Ltd. */
{ 342,  600, NETWK_TYPE_PCS_1900, "LIME", "LIME" }, // 2009.09.09 �߳��� ���� �׷� �Ⱥ��� ���� ��û
#else
/* Cable & Wireless Barbados Ltd. */
{ 342,  600, NETWK_TYPE_PCS_1900, "Cable&Wireless", "Cable&Wireless" }, // 2009.09.09 �߳��� ���� �׷� �Ⱥ��� ���� ��û
#endif
/* Digicel (Barbados) Limited */
...
/* Antigua Public Utilities Authority-APUA */
{ 344,  30, NETWK_TYPE_PCS_1900, "APUA PCS", "APUA PCS" }, // 2009.09.09 �߳��� ���� �׷� �Ⱥ��� ���� ��û
#if defined (CONFIG_LTN_COMMON) 
/* Cable & Wireless Caribbean Cellular (Antigua) Limited */
{ 344,  92, NETWK_TYPE_GSM_850, "LIME", "LIME" }, // 2009.05.27 ������ ���� ��û
/* Cable & Wireless Caribbean Cellular (Antigua) Limited */
{ 344,  920, NETWK_TYPE_GSM_850, "LIME", "LIME" }, 
#else
/* Cable & Wireless Caribbean Cellular (Antigua) Limited */
{ 344,  92, NETWK_TYPE_GSM_850, "Cable&Wireless", "Cable&Wireless" }, // 2009.09.09 �߳��� ���� �׷� �Ⱥ��� ���� ��û
/* Cable & Wireless Caribbean Cellular (Antigua) Limited */
...
{ 346,  14, NETWK_TYPE_PCS_1900, "LIME", "LIME" }, // 2009.09.09 �߳��� ���� �׷� �Ⱥ��� ���� ��û
/* Cable & Wireless (Cayman Islands) Limited */
{ 346,  14, NETWK_TYPE_GSM_850, "LIME", "LIME" }, // 2009.09.09 �߳��� ���� �׷� �Ⱥ��� ���� ��û
/* Cable & Wireless (Cayman Islands) Limited */
{ 346,  140, NETWK_TYPE_PCS_1900, "LIME", "LIME" }, // 2009.09.09 �߳��� ���� �׷� �Ⱥ��� ���� ��û
/* Cable & Wireless (Cayman Islands) Limited */
{ 346,  140, NETWK_TYPE_GSM_850, "LIME", "LIME" }, // 2009.09.09 �߳��� ���� �׷� �Ⱥ��� ���� ��û
/* Cable & Wireless (Cayman Islands) Limited */
{ 348,  17, NETWK_TYPE_GSM_850, "LIME", "LIME" }, // 2009.09.09 �߳��� ���� �׷� �Ⱥ��� ���� ��û
/* British Virgin Islands Digicel */
{ 348,   77, NETWK_TYPE_GSM_900,  "Digicel", "Digicel" },  // 2010.10.02 ������ ������ Ȯ��
/* Cable & Wireless (Cayman Islands) Limited */
{ 348,  170, NETWK_TYPE_GSM_850, "LIME", "LIME" }, // 2009.09.09 �߳��� ���� �׷� �Ⱥ��� ���� ��û
/* British Virgin Islands Digicel */
{ 348,  770, NETWK_TYPE_GSM_900,  "Digicel", "Digicel" },  // 2010.10.02 ������ ������ Ȯ��
#else
/* Cable & Wireless (Cayman Islands) Limited */
{ 346,  14, NETWK_TYPE_PCS_1900, "Cable&Wireless", "Cable&Wireless" }, // 2009.09.09 �߳��� ���� �׷� �Ⱥ��� ���� ��û
/* Cable & Wireless (Cayman Islands) Limited */
{ 346,  14, NETWK_TYPE_GSM_850, "Cable&Wireless", "Cable&Wireless" }, // 2009.09.09 �߳��� ���� �׷� �Ⱥ��� ���� ��û
/* Cable & Wireless (Cayman Islands) Limited */
{ 346,  140, NETWK_TYPE_PCS_1900, "Cable&Wireless", "Cable&Wireless" }, // 2009.09.09 �߳��� ���� �׷� �Ⱥ��� ���� ��û
/* Cable & Wireless (Cayman Islands) Limited */
{ 346,  140, NETWK_TYPE_GSM_850, "Cable&Wireless", "Cable&Wireless" }, // 2009.09.09 �߳��� ���� �׷� �Ⱥ��� ���� ��û
/* Cable & Wireless (Cayman Islands) Limited */
{ 348,  17, NETWK_TYPE_GSM_850, "Cable&Wireless", "Cable&Wireless" }, // 2009.09.09 �߳��� ���� �׷� �Ⱥ��� ���� ��û
/* Cable & Wireless (Cayman Islands) Limited */
{ 348,  170, NETWK_TYPE_GSM_850, "Cable&Wireless", "Cable&Wireless" }, // 2009.09.09 �߳��� ���� �׷� �Ⱥ��� ���� ��û
#endif
...
{ 352, 3, NETWK_TYPE_GSM_900, "Digicel", "Digicel" },  // 2009.09.09 �߳��� ���� �׷� �Ⱥ��� ���� ��û
#if defined (CONFIG_LTN_COMMON) 
/* Cable & Wireless Caribbean Cellular (Grenada) Limited */
{ 352,  11, NETWK_TYPE_GSM_850, "LIME", "LIME" }, // 2009.09.09 �߳��� ���� �׷� �Ⱥ��� ���� ��û
#else
/* Cable & Wireless Caribbean Cellular (Grenada) Limited */
{ 352,  11, NETWK_TYPE_GSM_850, "Cable&Wireless", "Cable&Wireless" }, // 2009.09.09 �߳��� ���� �׷� �Ⱥ��� ���� ��û
#endif
/* Grenada Wireless Holdings Ltd */
{ 352, 30, NETWK_TYPE_PCS_1900, "Digicel", "Digicel" }, // 2009.09.09 �߳��� ���� �׷� �Ⱥ��� ���� ��û
#if defined (CONFIG_LTN_COMMON) 
/* Cable & Wireless Caribbean Cellular (Grenada) Limited */
{ 352,  110, NETWK_TYPE_GSM_850, "LIME", "LIME" },   // 2009.09.09 �߳��� ���� �׷� �Ⱥ��� ���� ��û
/* Cable & Wireless Caribbean Cellular (Grenada) Limited */
{ 354, 86, NETWK_TYPE_GSM_850, "LIME", "LIME" }, // 2009.09.09 �߳��� ���� �׷� �Ⱥ��� ���� ��û
/* Cable & Wireless Caribbean Cellular (Grenada) Limited */
{ 354, 860, NETWK_TYPE_GSM_850, "LIME", "LIME" }, // 2009.09.09 �߳��� ���� �׷� �Ⱥ��� ���� ��û
#else
/* Cable & Wireless Caribbean Cellular (Grenada) Limited */
{ 352,  110, NETWK_TYPE_GSM_850, "Cable&Wireless", "Cable&Wireless" },   // 2009.09.09 �߳��� ���� �׷� �Ⱥ��� ���� ��û
/* Cable & Wireless Caribbean Cellular (Grenada) Limited */
{ 354, 86, NETWK_TYPE_GSM_850, "Cable&Wireless", "Cable&Wireless" }, // 2009.09.09 �߳��� ���� �׷� �Ⱥ��� ���� ��û
/* Cable & Wireless Caribbean Cellular (Grenada) Limited */
{ 354, 860, NETWK_TYPE_GSM_850, "Cable&Wireless", "Cable&Wireless" }, // 2009.09.09 �߳��� ���� �׷� �Ⱥ��� ���� ��û
#endif
/*********************
 **** St Kitts & Nevis ****
 *********************/
...
{ 356,  11, NETWK_TYPE_GSM_850, "LIME", "LIME" }, // 2009.09.09 �߳��� ���� �׷� �Ⱥ��� ���� ��û
/* Cable & Wireless St Kitts & Nevis Limited */
{ 356,  110, NETWK_TYPE_GSM_850, "LIME", "LIME" }, // 2009.09.09 �߳��� ���� �׷� �Ⱥ��� ���� ��û
/* Cable & Wireless St Kitts & Nevis Limited */
{ 356, 110, NETWK_TYPE_PCS_1900, "LIME", "LIME" },  // 2009.09.09 �߳��� ���� �׷� �Ⱥ��� ���� ��û
#else
/* Cable & Wireless St Kitts & Nevis Limited */
{ 356,  11, NETWK_TYPE_GSM_850, "Cable&Wireless", "Cable&Wireless" }, // 2009.09.09 �߳��� ���� �׷� �Ⱥ��� ���� ��û
/* Cable & Wireless St Kitts & Nevis Limited */
{ 356,  110, NETWK_TYPE_GSM_850, "Cable&Wireless", "Cable&Wireless" }, // 2009.09.09 �߳��� ���� �׷� �Ⱥ��� ���� ��û
/* Cable & Wireless St Kitts & Nevis Limited */
{ 356, 110, NETWK_TYPE_PCS_1900, "Cable&Wireless", "Cable&Wireless" },  // 2009.09.09 �߳��� ���� �׷� �Ⱥ��� ���� ��û
#endif
...
{ 358, 5, NETWK_TYPE_GSM_900, "Digicel", "Digicel" }, // 2009.09.09 �߳��� ���� �׷� �Ⱥ��� ���� ��û
#if defined (CONFIG_LTN_COMMON) 
/* Cable & Wireless Caribbean Cellular (St Lucia) Limited */
{ 358, 11, NETWK_TYPE_GSM_850, "LIME", "LIME" },  // 2009.09.09 �߳��� ���� �׷� �Ⱥ��� ���� ��û
#else
/* Cable & Wireless Caribbean Cellular (St Lucia) Limited */
{ 358, 11, NETWK_TYPE_GSM_850, "Cable&Wireless", "Cable&Wireless" },  // 2009.09.09 �߳��� ���� �׷� �Ⱥ��� ���� ��û
#endif
...
/* Digicel (St Lucia) Limited */
{ 358, 50, NETWK_TYPE_PCS_1900, "Digicel", "Digicel" }, // 2009.09.09 �߳��� ���� �׷� �Ⱥ��� ���� ��û
#if defined (CONFIG_LTN_COMMON) 
/* Cable & Wireless Caribbean Cellular (St Lucia) Limited */
{ 358, 110, NETWK_TYPE_GSM_850, "LIME", "LIME" }, // 2009.09.09 �߳��� ���� �׷� �Ⱥ��� ���� ��û
#else
/* Cable & Wireless Caribbean Cellular (St Lucia) Limited */
{ 358, 110, NETWK_TYPE_GSM_850, "Cable&Wireless", "Cable&Wireless" }, // 2009.09.09 �߳��� ���� �׷� �Ⱥ��� ���� ��û
#endif
...
{ 360,  11, NETWK_TYPE_GSM_850, "LIME", "LIME" }, // 2009.09.09 �߳��� ���� �׷� �Ⱥ��� ���� ��û
#else
/* Cable & Wireless Caribbean Cellular (St. Vincent & the Grenadines) Ltd */
{ 360,  11, NETWK_TYPE_GSM_850, "Cable&Wireless", "Cable&Wireless" }, // 2009.09.09 �߳��� ���� �׷� �Ⱥ��� ���� ��û
#endif
/* Digicel (St. Vincent and the Grenadines) Limited */
{ 360, 70, NETWK_TYPE_GSM_900, "Digicel", "Digicel" }, // 2009.09.09 �߳��� ���� �׷� �Ⱥ��� ���� ��û
/* Digicel (St. Vincent and the Grenadines) Limited */
{ 360, 70, NETWK_TYPE_DCS_1800, "Digicel", "Digicel" }, // 2009.09.09 �߳��� ���� �׷� �Ⱥ��� ���� ��û
#if defined (CONFIG_LTN_COMMON) 
/* Cable & Wireless Caribbean Cellular (St. Vincent & the Grenadines) Ltd */
{ 360,  110, NETWK_TYPE_GSM_850, "LIME", "LIME" },// 2009.09.09 �߳��� ���� �׷� �Ⱥ��� ���� ��û
#else
/* Cable & Wireless Caribbean Cellular (St. Vincent & the Grenadines) Ltd */
{ 360,  110, NETWK_TYPE_GSM_850, "Cable&Wireless", "Cable&Wireless" },// 2009.09.09 �߳��� ���� �׷� �Ⱥ��� ���� ��û
#endif
...
{ 365,  84, NETWK_TYPE_GSM_850, "LIME", "LIME" }, // 2009.09.09 �߳��� ���� �׷� �Ⱥ��� ���� ��û
/* Cable & Wireless (West Indies) Ltd. Anguilla */
{ 365,  840, NETWK_TYPE_GSM_850, "LIME", "LIME" }, // 2009.09.09 �߳��� ���� �׷� �Ⱥ��� ���� ��û
#else
/* Cable & Wireless (West Indies) Ltd. Anguilla */
{ 365,  84, NETWK_TYPE_GSM_850, "Cable&Wireless", "Cable&Wireless" }, // 2009.09.09 �߳��� ���� �׷� �Ⱥ��� ���� ��û
/* Cable & Wireless (West Indies) Ltd. Anguilla */
{ 365,  840, NETWK_TYPE_GSM_850, "Cable&Wireless", "Cable&Wireless" }, // 2009.09.09 �߳��� ���� �׷� �Ⱥ��� ���� ��û
#endif
...
{ 366,  11, NETWK_TYPE_GSM_850, "LIME", "LIME" }, // 2009.09.09 �߳��� ���� �׷� �Ⱥ��� ���� ��û
#else
 /* Cable & Wireless Dominica Ltd. */
{ 366,  11, NETWK_TYPE_GSM_850, "Cable&Wireless", "Cable&Wireless" }, // 2009.09.09 �߳��� ���� �׷� �Ⱥ��� ���� ��û
#endif
...
#if defined (CONFIG_LTN_COMMON) 
/* Cable & Wireless Dominica Ltd. */
{ 366,  110, NETWK_TYPE_GSM_850, "LIME", "LIME" }, // 2009.09.09 �߳��� ���� �׷� �Ⱥ��� ���� ��û
#else
/* Cable & Wireless Dominica Ltd. */
{ 366,  110, NETWK_TYPE_GSM_850, "Cable&Wireless", "Cable&Wireless" }, // 2009.09.09 �߳��� ���� �׷� �Ⱥ��� ���� ��û
#endif
...
{ 370,   1, NETWK_TYPE_GSM_900, "Orange", "Orange" },// D0100306029 2011/9/16 Orange ������ ��û
/* Orange Dominicana S.A. */
{ 370,   1, NETWK_TYPE_DCS_1800, "Orange", "Orange" },// D0100306029 2011/9/16 Orange ������ ��û
/* Orange Dominicana S.A. */
{ 370,   1, NETWK_TYPE_PCS_1900, "Orange", "Orange" },// 2009.09.01 �߳��� ���� �׷� �Ⱥ��� ���� ��û
#else
/* Orange Dominicana S.A. */
{ 370,   1, NETWK_TYPE_GSM_900, "orange", "orange" },// D0100306029 2011/9/16 Orange ������ ��û
/* Orange Dominicana S.A. */
...
{ 376, 35, NETWK_TYPE_GSM_850, "LIME", "LIME" }, // 2009.09.09 �߳��� ���� �׷� �Ⱥ��� ���� ��û
/* Cable & Wireless West Indies Ltd (Turks & Caicos) */
{ 376, 350, NETWK_TYPE_GSM_850, "LIME", "LIME" }, // 2009.09.09 �߳��� ���� �׷� �Ⱥ��� ���� ��û
#else
/* Cable & Wireless West Indies Ltd (Turks & Caicos) */
{ 376, 35, NETWK_TYPE_GSM_850, "Cable&Wireless", "Cable&Wireless" }, // 2009.09.09 �߳��� ���� �׷� �Ⱥ��� ���� ��û
/* Cable & Wireless West Indies Ltd (Turks & Caicos) */
{ 376, 350, NETWK_TYPE_GSM_850, "Cable&Wireless", "Cable&Wireless" }, // 2009.09.09 �߳��� ���� �׷� �Ⱥ��� ���� ��û
#endif
/********************
 **** Azerbaijan ****
 ********************/
 ...
 ******************/
/* Mobilink */
{ 410,   1, NETWK_TYPE_GSM_900, "Mobilink", "Mobilink" },// 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
{ 410,   1, NETWK_TYPE_DCS_1800, "Mobilink", "Mobilink" },// 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
/* Ufone */
{ 410,   3, NETWK_TYPE_GSM_900, "Ufone", "Ufone" },// 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
/* Paktel  */
{ 410, 4, NETWK_TYPE_GSM_900, "ZONG", "ZONG" }, // 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
{ 410, 4, NETWK_TYPE_DCS_1800, "ZONG", "ZONG" },// 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
/* Telenor Pakistan */
{ 410, 6, NETWK_TYPE_GSM_900, "Telenor", "Telenor" }, // 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
{ 410, 6, NETWK_TYPE_DCS_1800, "Telenor", "Telenor" }, // 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
/* Warid Telecom */
{ 410, 7, NETWK_TYPE_GSM_900, "Warid", "Warid" }, // 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
{ 410, 7, NETWK_TYPE_DCS_1800, "Warid", "Warid" }, // 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
 ...
 *****************/
/* Alfa */
{ 415,   1, NETWK_TYPE_GSM_900, "Alfa", "Alfa" },// 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
/* MTC Touch */
{ 415,   3, NETWK_TYPE_GSM_900, "MTC Touch", "MTC Touch" },// 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341

/****************
 **** Jordan ****
 ****************/
/* Fastlink */
{ 416,   1, NETWK_TYPE_GSM_900, "zain JO", "zain JO" },// 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
/* Umniah */
{ 416,   3, NETWK_TYPE_DCS_1800, "Umniah", "Umniah" }, // 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
/* MOBILECOM */
{ 416,  77, NETWK_TYPE_GSM_900, "Orange JO", "Orange JO" },// 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341

/***************
 **** Syria ****
 ***************/
 /* SYRIATEL */
{ 417,   1, NETWK_TYPE_GSM_900, "SYRIATEL", "SYRIATEL" },// 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
{ 417,   1, NETWK_TYPE_DCS_1800, "SYRIATEL", "SYRIATEL" },// 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
 /* MTN Syria */
{ 417,   2, NETWK_TYPE_GSM_900, "MTN Syria", "MTN Syria" },// 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
{ 417,   2, NETWK_TYPE_DCS_1800, "MTN Syria", "MTN Syria" },// 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
/* MOBILE SYRIA */
{ 417,   9, NETWK_TYPE_GSM_900, "MOBILE SYRIA", "MOBILE SYRIA" },// 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
...
{ 418, 0, NETWK_TYPE_GSM_900, "ASIACELL", "ASIACELL" }, // 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
/* SanaTel */
{ 418, 2, NETWK_TYPE_GSM_900, "SanaTel", "SanaTel" }, // 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
/* ASIACELL */
{ 418,   5, NETWK_TYPE_GSM_900, "ASIACELL", "ASIACELL" }, // 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
/* SanaTel */
{ 418, 8, NETWK_TYPE_GSM_900, "SanaTel", "SanaTel" }, // 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
/* Atheer */
{ 418,   20, NETWK_TYPE_GSM_900, "Zain Iraq", "Zain Iraq" },// 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
/* Zain Iraq */
{ 418,   30, NETWK_TYPE_GSM_900, "Zain Iraq", "Zain Iraq" },// 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
/* Korek Telecom */
{ 418,   40, NETWK_TYPE_GSM_900, "Korek Telecom", "Korek Telecom" },// 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
/* mobitel */
{ 418,   45, NETWK_TYPE_UMTS, "mobitel", "mobitel" },// 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341

/****************
 **** Kuwait ****
 ****************/
/* MTCNet */
{ 419,   2, NETWK_TYPE_GSM_900, "zain KW", "zain KW" },// 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
{ 419,   2, NETWK_TYPE_DCS_1800, "zain KW", "zain KW" },// 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
{ 419,   2, NETWK_TYPE_UMTS, "zain KW", "zain KW" },// 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
/* Wataniya Telecom */
{ 419,   3, NETWK_TYPE_GSM_900, "WATANIYA", "WATANIYA" },// 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
{ 419,   3, NETWK_TYPE_DCS_1800, "WATANIYA", "WATANIYA" },// 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
/* VIVA */
 ...
 **********************/
/* Al JAWAL */
{ 420,   1, NETWK_TYPE_GSM_900, "SA Al Jawal", "SA Al Jawal" },// 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
{ 420,   1, NETWK_TYPE_UMTS, "SA Al Jawal", "SA Al Jawal" },// 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
/* Mobily */
{ 420, 3, NETWK_TYPE_GSM_900, "mobily", "mobily" }, // 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
{ 420, 3, NETWK_TYPE_UMTS, "mobily", "mobily" },// 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
/* zain SA */
{ 420, 4, NETWK_TYPE_GSM_900, "zain SA", "zain SA" }, // 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
{ 420, 4, NETWK_TYPE_DCS_1800, "zain SA", "zain SA" },// 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
{ 420, 4, NETWK_TYPE_UMTS, "zain SA", "zain SA" },// 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
 ...
 ***************/
/* SABAFON */
{ 421,   1, NETWK_TYPE_GSM_900, "SABAFON", "SABAFON" },// 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
/* Spacetel */
{ 421,   2, NETWK_TYPE_GSM_900, "MTN", "MTN" },// 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341

/**************
 **** Oman ****
 **************/
/* OMANTEL */
{ 422,   2, NETWK_TYPE_GSM_900, "OMAN MOBILE", "OMAN MOBILE" }, // 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
/* nawras  */
{ 422, 3, NETWK_TYPE_GSM_900, "nawras", "nawras" },  // 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341

/******************************
 **** United Arab Emirates ****
 ******************************/
/* UAE Etisalat */
{ 424,   2, NETWK_TYPE_GSM_900, "ETISALAT", "ETISALAT" }, // 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
{ 424,   2, NETWK_TYPE_UMTS, "ETISALAT", "ETISALAT" }, // 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
/* du */
{ 424,   3, NETWK_TYPE_GSM_900, "du", "du" }, // 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
{ 424,   3, NETWK_TYPE_DCS_1800, "du", "du" }, // 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
{ 424,   3, NETWK_TYPE_UMTS, "du", "du" }, // 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
...
{ 426,   1, NETWK_TYPE_GSM_900, "BATELCO", "BATELCO" },// 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
/* MTC-Vodafone */
{ 426,   2, NETWK_TYPE_GSM_900, "zain BH", "zain BH" },// 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
{ 426,   2, NETWK_TYPE_DCS_1800, "zain BH", "zain BH" },// 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
{ 426,   2, NETWK_TYPE_UMTS, "zain BH", "zain BH" }, // 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
 ...
 ***************/
/* Q-Tel */
{ 427,   1, NETWK_TYPE_GSM_900, "Qatarnet", "Qatarnet" },// 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
{ 427,   1, NETWK_TYPE_DCS_1800, "Qatarnet", "Qatarnet" },// 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
...
/* TKC */
{ 432,  14, NETWK_TYPE_GSM_900, "TKC", "TKC" }, // 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
/* MTCE */
{ 432,  19, NETWK_TYPE_GSM_900, "MTCE", "MTCE" }, // 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
/* Taliya */
{ 432, 32, NETWK_TYPE_GSM_900, "Taliya", "Taliya" }, // 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
/* Irancell */
{ 432, 35, NETWK_TYPE_GSM_900, "Irancell", "Irancell" },// 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
{ 432, 35, NETWK_TYPE_DCS_1800, "Irancell", "Irancell" }, // 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
...
{ 537,   3, NETWK_TYPE_GSM_900,  "Digicel", "Digicel" },  // 2010.10.02 ������ ������ Ȯ��
#endif
...
#if defined (CONFIG_LTN_COMMON)  
/* Tonga Digicel */
{ 539,   88, NETWK_TYPE_GSM_900,  "Digicel", "Digicel" },  // 2010.10.02 ������ ������ Ȯ��
#endif
...
#if defined (CONFIG_LTN_COMMON)  
/* Vanuatu Digicel */
{ 541,   5, NETWK_TYPE_GSM_900,  "Digicel", "Digicel" },  // 2010.10.02 ������ ������ Ȯ��
#endif
...
#if defined (CONFIG_LTN_COMMON)  
/* Fiji Digicel */
{ 542,   2, NETWK_TYPE_GSM_900,  "Digicel", "Digicel" },  // 2010.10.02 ������ ������ Ȯ��
#endif
...
/* Vodafone */
{ 602,   2, NETWK_TYPE_GSM_900, "vodafone", "vodafone" },// 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
{ 602,   2, NETWK_TYPE_UMTS, "vodafone", "vodafone" },// 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
/* Etisalat */
{ 602,   3, NETWK_TYPE_GSM_900, "Etisalat", "Etisalat" },// 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
{ 602,   3, NETWK_TYPE_DCS_1800, "Etisalat", "Etisalat" },// 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
{ 602,   3, NETWK_TYPE_UMTS, "Etisalat", "Etisalat" },// 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
/*****************
 **** Algeria ****
 *****************/
/* Algerie Telecom */
{ 603,   1, NETWK_TYPE_GSM_900, "Mobilis", "Mobilis" },// 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
/* Orascom Telecom Algerie Spa */
{ 603,   2, NETWK_TYPE_GSM_900, "Djezzy", "Djezzy" },// 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
{ 603,   2, NETWK_TYPE_DCS_1800, "Djezzy", "Djezzy" },// 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
/* Wataniya Telecom Algerie */
{ 603, 3, NETWK_TYPE_GSM_900, "Nedjma", "Nedjma" }, // 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
{ 603, 3, NETWK_TYPE_DCS_1800, "Nedjma", "Nedjma" }, // 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341

/*****************
 **** Morocco ****
 *****************/
/* Medi Telecom */
{ 604,   0, NETWK_TYPE_GSM_900, "Meditel", "Meditel" },// 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
/* Itissalat Al-Maghrib S.A */
{ 604,   1, NETWK_TYPE_GSM_900, "IAM", "IAM" },// 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
/* WANA GSM */
...
{ 606, 0, NETWK_TYPE_GSM_900, "Libyana", "Libyana" }, // 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
{ 606, 0, NETWK_TYPE_DCS_1800, "Libyana", "Libyana" },// 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
/* AL MADAR Telecomm Company */
{ 606, 1, NETWK_TYPE_GSM_900, "Almadar", "Almadar" }, // 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
 ...
 ***************/
/* ScanCom Ltd */
{ 620,   1, NETWK_TYPE_GSM_900, "MTN", "MTN" },//2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
/* Ghana Telecommunications Company Ltd */
{ 620,   2, NETWK_TYPE_GSM_900, "GH Onetouch", "GH Onetouch" },//2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
/* Millicom Ghana Limited */
{ 620,   3, NETWK_TYPE_GSM_900, "Tigo", "Tigo" },//2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
/* Zain Gh */
{ 620,   6, NETWK_TYPE_GSM_900, "Zain Gh", "Zain Gh" },//2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
{ 620,   6, NETWK_TYPE_DCS_1800, "Zain Gh", "Zain Gh" },//2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341

/*****************
 **** Nigeria ****
 *****************/
/* Globacom Limited */
{ 621,  20, NETWK_TYPE_GSM_900, "Celtel Nigeria", "Celtel Nigeria" },// 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
{ 621,  20, NETWK_TYPE_DCS_1800, "Celtel Nigeria", "Celtel Nigeria" },// 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
{ 621,  20, NETWK_TYPE_UMTS, "Celtel Nigeria", "Celtel Nigeria" },// 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341

/* MTN Nigeria Communications Limited */
{ 621,  30, NETWK_TYPE_GSM_900, "MTN Nigeria", "MTN Nigeria" },// 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
{ 621,  30, NETWK_TYPE_DCS_1800, "MTN Nigeria", "MTN Nigeria" },// 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341

/* Nigerian Mobile Telecommunications Limited (MTEL) */
{ 621,  40, NETWK_TYPE_GSM_900, "Mtel", "Mtel" },// 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
{ 621,  40, NETWK_TYPE_DCS_1800, "Mtel", "Mtel" },// 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341

/* Celtel Nigeria Limited */
{ 621,  50, NETWK_TYPE_GSM_900, "Glo Mobile", "Glo Mobile" },// 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
{ 621,  50, NETWK_TYPE_DCS_1800, "Glo Mobile", "Glo Mobile" },// 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
...
/* UNITEL */
{ 631,   2, NETWK_TYPE_GSM_900, "UNITEL", "UNITEL" }, //angola 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
{ 631,   2, NETWK_TYPE_DCS_1800, "UNITEL", "UNITEL" }, //angola 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
 ...
 ***************/
/* Safaricom Limited */
{ 639,   2, NETWK_TYPE_GSM_900, "Safaricom", "Safaricom" },// 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
{ 639,   2, NETWK_TYPE_DCS_1800, "Safaricom", "Safaricom" },// 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
/* Celtel Kenya Limited */
{ 639,   3, NETWK_TYPE_GSM_900, "ZAIN KE", "ZAIN KE" },// 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
/* Econet */
{ 639,   5, NETWK_TYPE_GSM_900, "Econet", "Econet" },//�űԻ����� 09�� 1�� ��Ī��� , 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
/* Telkom Kenya Limited */
{ 639,   7, NETWK_TYPE_GSM_900, "Orange", "Orange" },// 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
{ 639,   7, NETWK_TYPE_DCS_1800, "Orange", "Orange" },// 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
/******************
 **** Tanzania ****
 ******************/
/* Tritel (T) Ltd */
...
/* MIC Tanzania Ltd */
{ 640,   2, NETWK_TYPE_GSM_900, "Tigo", "Tigo" },// 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
{ 640,   2, NETWK_TYPE_DCS_1800, "Tigo", "Tigo" },// 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341

/* Zanzibar Telecom */
{ 640,   3, NETWK_TYPE_GSM_900, "ZANTEL", "ZANTEL" },// 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
{ 640,   3, NETWK_TYPE_DCS_1800, "ZANTEL", "ZANTEL" },// 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341

/* Vodacom Tanzania Ltd */
{ 640,   4, NETWK_TYPE_GSM_900, "Vodacom", "Vodacom" },// 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
{ 640,   4, NETWK_TYPE_DCS_1800, "Vodacom", "Vodacom" },// 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341

/* Celtel Tanzania Limited */
{ 640,   5, NETWK_TYPE_GSM_900, "ZAIN TZ", "ZAIN TZ" },// 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
{ 640,   5, NETWK_TYPE_DCS_1800, "ZAIN TZ", "ZAIN TZ" },// 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
/* Celtel Tanzania Limited ******
...
{ 643,   1, NETWK_TYPE_GSM_900, "mCel", "mCel" },// 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
/* Mozambique Celluar S.A.R.L. */
{ 643,   1, NETWK_TYPE_DCS_1800, "mCel", "mCel" },// 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
/* VM, S.A.R.L. */
{ 643,   4, NETWK_TYPE_GSM_900, "Vodacom", "Vodacom" },// 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
/* VM, S.A.R.L. */
{ 643,   4, NETWK_TYPE_DCS_1800, "Vodacom", "Vodacom" },// 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
...
/* Vodacom (Pty) Ltd */
{ 655,   1, NETWK_TYPE_GSM_900, "RSA Vodacom", "RSA Vodacom" },// 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
{ 655,   1, NETWK_TYPE_UMTS, "RSA Vodacom", "RSA Vodacom" },// 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341

/*Telkom ,Ltd */
{ 655,   2, NETWK_TYPE_GSM_900, "RSA 8ta", "RSA 8ta" },// 2009.9.1 �߾ư��߱׷� �̿뱸 å�� ��û
{ 655,   2, NETWK_TYPE_DCS_1800,  "RSA 8ta", "RSA 8ta" },// 2009.9.1 �߾ư��߱׷� �̿뱸 å�� ��û
{ 655,   2, NETWK_TYPE_UMTS,  "RSA 8ta", "RSA 8ta" },// 2009.9.1 �߾ư��߱׷� �̿뱸 å�� ��û

/* Cell C (Pty) Ltd */
{ 655,   7, NETWK_TYPE_GSM_900, "RSA CELL C", "RSA CELL C" },// 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
{ 655,   7, NETWK_TYPE_DCS_1800, "RSA CELL C", "RSA CELL C" },// 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341

/* MTN - Mobile Telephone Networks (Pty) Ltd. */
{ 655,  10, NETWK_TYPE_GSM_900, "RSA MTN", "RSA MTN" },// 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
{ 655,  10, NETWK_TYPE_DCS_1800, "RSA MTN", "RSA MTN" },// 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
{ 655,  10, NETWK_TYPE_UMTS, "RSA MTN", "RSA MTN" },// 2009.9.1 �߾ư��߱׷� �ڿ��� ���� ��û. CR B0100230341
...
#if defined (CONFIG_LTN_COMMON)  
/* Honduras Digicel */
{ 708,   4, NETWK_TYPE_GSM_900,  "Digicel", "Digicel" },  // 2010.10.02 ������ ������ Ȯ��
#endif
...
{ 712, 2, NETWK_TYPE_DCS_1800, "ICE", "ICE" }, // 2009.09.01 �߳��� ���� �׷� �Ⱥ��� ���� ��û
#if defined (CONFIG_LTN_COMMON)
...
/* Telemig Celular S/A */
{ 724, 23, NETWK_TYPE_DCS_1800, "VIVO", "VIVO" }, // 2009.09.01 �߳��� ���� �׷� �Ⱥ��� ���� ��û
#if defined(CONFIG_LTN_COMMON)
/* Amazonia Celular S/A */
{ 724, 24, NETWK_TYPE_GSM_900, "Oi", "Oi" }, // 2009.09.01 �߳��� ���� �׷� �Ⱥ��� ���� ��û
/* Amazonia Celular S/A */
{ 724, 24, NETWK_TYPE_DCS_1800, "Oi", "Oi" }, // 2009.09.01 �߳��� ���� �׷� �Ⱥ��� ���� ��û 
#else
/* Amazonia Celular S/A */
{ 724, 24, NETWK_TYPE_GSM_900, "Amazonia Cel", "Amazonia Cel" }, // 2009.09.01 �߳��� ���� �׷� �Ⱥ��� ���� ��û
/* Amazonia Celular S/A */
{ 724, 24, NETWK_TYPE_DCS_1800, "Amazonia Cel", "Amazonia Cel" }, // 2009.09.01 �߳��� ���� �׷� �Ⱥ��� ���� ��û 
#endif	
/* TNL PCS S.A. */
...
{ 730,   11, NETWK_TYPE_PCS_1900, "ENTEL PCS", "ENTEL PCS" }, // 2009.09.01 �߳��� ���� �׷� �Ⱥ��� ���� ��û
#endif
/* Telefonica  Movil de Chile */
{ 730,   23, NETWK_TYPE_PCS_1900, "movistar", "movistar" },// 2009.09.01 �߳��� ���� �׷� �Ⱥ��� ���� ��û
#if defined (CONFIG_LTN_COMMON)  
{ 730,   101, NETWK_TYPE_PCS_1900, "Entel", "Entel" },
#else
{ 730,   101, NETWK_TYPE_PCS_1900, "ENTEL PCS", "ENTEL PCS" }, // 2009.09.01 �߳��� ���� �׷� �Ⱥ��� ���� ��û
#endif
/*****************
 **** Colombia ****
 *****************/
...
#else
/* Occidente y Caribe Celular SA Occel SA */
{ 732,  101, NETWK_TYPE_GSM_850, "COMCEL 3GSM", "COMCEL 3GSM" }, // 2009.09.01 �߳��� ���� �׷� �Ⱥ��� ���� ��û
/* Comunicacion Celular SA Comcel SA */
{ 732,  101, NETWK_TYPE_PCS_1900, "COMCEL 3GSM", "COMCEL 3GSM" }, // 2009.09.01 �߳��� ���� �׷� �Ⱥ��� ���� ��û
#endif
/* Colombia Movil SA */
...
{ 732,  111, NETWK_TYPE_GSM_900, "TIGO", "TIGO" }, // 2009.09.01 �߳��� ���� �׷� �Ⱥ��� ���� ��û
#if defined (CONFIG_LTN_COMMON)
/* Telefonica Moviles Colombia S.A. */
{ 732,  123, NETWK_TYPE_GSM_850, "movistar", "movistar" }, // 2009.09.01 �߳��� ���� �׷� �Ⱥ��� ���� ��û
/* Telefonica Moviles Colombia S.A. */
{ 732,  123, NETWK_TYPE_PCS_1900, "movistar", "movistar" }, // 2009.09.01 �߳��� ���� �׷� �Ⱥ��� ���� ��û
#else
/* Telefonica Moviles Colombia S.A. */
...
#else
/* Nuevatel PCS De Bolivia SA */
{ 736,   1, NETWK_TYPE_PCS_1900, "NUEVATEL", "NUEVATEL" }, // 2009.09.09 �߳��� ���� �׷� �Ⱥ��� ���� ��û
/* Entel SA */
{ 736,   2, NETWK_TYPE_PCS_1900, "MOVIL-E", "MOVIL-E" }, // 2009.09.09 �߳��� ���� �׷� �Ⱥ��� ���� ��û
/* Telefonica Celular De Bolivia S.A. */
{ 736, 3, NETWK_TYPE_GSM_850, "TIGO", "TIGO" }, // 2009.09.09 �߳��� ���� �׷� �Ⱥ��� ���� ��û
#endif
...
/* Cel*Star Guyana Inc */
#if defined (CONFIG_LTN_COMMON)  
{ 738, 1, NETWK_TYPE_GSM_900, "Digicel", "Digicel" }, // 2010.10.02 ������ ������ Ȯ��
#else
{ 738, 1, NETWK_TYPE_GSM_900, "Cel*Star", "Cel*Star" }, // 2009.09.09 �߳��� ���� �׷� �Ⱥ��� ���� ��û
#endif
...
#else
{ 744, 1, NETWK_TYPE_PCS_1900, "HPGYSA", "HPGYSA" }, // 2009.09.01 �߳��� ���� �׷� �Ⱥ��� ���� ��û
#endif
...
#else
/* Telesur */
{ 746,   2, NETWK_TYPE_GSM_900, "Telesur", "Telesur" },// 2009.09.09 �߳��� ���� �׷� �Ⱥ��� ���� ��û
/* NV ICMS */
{ 746,   2, NETWK_TYPE_DCS_1800, "Telesur", "Telesur" },// 2009.09.09 �߳��� ���� �׷� �Ⱥ��� ���� ��û
#endif
/* Digitel */
...
#if defined (CONFIG_LTN_COMMON) 
 /* ANCEL */
{ 748, 1, NETWK_TYPE_GSM_900, "ANTEL", "ANTEL" },
/* ANCEL */
