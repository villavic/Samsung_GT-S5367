...
GLOBAL const U8 reg_main_init_60hz[][2]
#if defined(_CAMACQ_API_C_)
={
/******************************************************
*
...
{0x08, 0x00},
    ...
    {0x03, 0x20},
    {0x10, 0x0c}, //60hz [Ltn_check : init_1/9]
    ...
    {0x41, 0x68},
    {0x42, 0x00},
{0x43, 0x44}, //60hz [Ltn_check : init_2/9]
    ...
    {0x84, 0x0c},
    {0x85, 0x00},
{0x90, 0x0f}, //60hz [Ltn_check : init_3/9]
{0x91, 0x10}, //60hz [Ltn_check : init_4/9]
    {0x92, 0x35},
    {0x93, 0x30},
    {0x94, 0xff},
    {0x95, 0xff},
...
{0x57, 0xb7},
    ...
    {0x83, 0x01},
{0x84, 0x86}, //60hz [Ltn_check : init_5/9]
{0x85, 0xa0}, //60hz [Ltn_check : init_6/9]
    ...
    {0x88, 0x05},
{0x89, 0xb8}, //60hz [Ltn_check : init_7/9]
{0x8a, 0xd8}, //60hz [Ltn_check : init_8/9]
...
{0xb8, 0x99},
    ...
    {0x03, 0x20},
{0x10, 0x8c}, // Check [Ltn_check : init_9/9]
...
// CAMERA_CAMCORDER
//==========================================================
GLOBAL const U8 reg_main_camcorder_60hz[][2]
#if defined(_CAMACQ_API_C_)
={
...
{0x03,0x20},
{0x10, 0x0C}, //60hz [Ltn_check : camcorder_1/2]
...
{0x03,0x20},
{0x10, 0x8C}, //60hz [Ltn_check : camcorder_2/2]
...
// CAMERA PREVIEW(640*480 / FULL)
//==========================================================
GLOBAL const U8 reg_main_preview_60hz[][2]
#if defined(_CAMACQ_API_C_)
={
	{0x03, 0x00}, 	
{0x01, 0xf9},
	...
	{0x03, 0x20}, 
	{0x18, 0x30}, 
{0x10, 0x0c}, //60hz [Ltn_check : preview_1/3]
	...
	{0x23, 0x0a},
       ...
       {0x42, 0x00}, 
{0x43, 0x44}, //60hz [Ltn_check : preview_2/3]
	...
	{0x03, 0x20},
{0x10, 0x8c}, //60hz [Ltn_check : preview_3/3] 
...
// CAMERA_SCENE_AGAINSTLIGHT (BACKLight??)
//==========================================================
GLOBAL const U8 reg_main_scene_againstlight_60hz[][2]
#if defined(_CAMACQ_API_C_)
={
{0x03, 0x00}, 
{0xa0, 0x00},
...
{0x03, 0x20}, 
{0x10, 0x0c}, //60hz	 [Ltn_check : SCN_Against_1/4]
{0x2e, 0x33}, 
...
{0x88, 0x05},
{0x89, 0xb8}, //60hz	 [Ltn_check : SCN_Against_2/4]
{0x8a, 0xd8}, //60hz	 [Ltn_check : SCN_Against_3/4]
...
{0xfe, 0x05},
{0x10, 0x8c}, //60hz 	[Ltn_check : SCN_Against_4/4]
...
// CAMERA_SCENE_AUTO (OFF)
//==========================================================
GLOBAL const U8 reg_main_scene_auto_60hz[][2]
#if defined(_CAMACQ_API_C_)
={
/* CAMERA_SCENEMODE_OFF */
...
{0x03, 0x20}, 
{0x10, 0x0c}, //60hz [Ltn_check : SCN_Auto_1/8]
{0x2e, 0x33}, 
...
{0x88, 0x05}, 
{0x89, 0xb8}, //60hz [Ltn_check : SCN_Auto_2/8] 
{0x8a, 0xd8}, //60hz [Ltn_check : SCN_Auto_3/8]
...
{0xfe, 0x05},
{0x10, 0x8c}, //60hz [Ltn_check : SCN_Auto_4/8]
...
{0x03, 0x20},
{0x10, 0x0c}, //60hz [Ltn_check : SCN_Auto_5/8]

{0x88, 0x05},
{0x89, 0xb8}, //60hz [Ltn_check : SCN_Auto_6/8]
{0x8A, 0xd8}, //60hz [Ltn_check : SCN_Auto_7/8]

{0xb2, 0x64}, 

{0x10, 0x8C}, //60hz [Ltn_check : SCN_Auto_8/8]
...
// CAMERA_SCENE_CANDLELIGHT
//==========================================================
GLOBAL const U8 reg_main_scene_candlelight_60hz[][2]
#if defined(_CAMACQ_API_C_)
={
...
{0x03, 0x20}, 
{0x10, 0x0c}, //60hz	 [Ltn_check : SCN_Candlelight_1/4]
{0x2e, 0x33}, 
...
{0x88, 0x05},
{0x89, 0xb8}, //60hz	 [Ltn_check : SCN_Candlelight_2/4]
{0x8a, 0xd8}, //60hz	 [Ltn_check : SCN_Candlelight_3/4]
...
{0xfe, 0x05},
{0x10, 0x8c}, //60hz	 [Ltn_check : SCN_Candlelight_4/4]
...
// CAMERA_SCENE_FALLCOLOR
//==========================================================
GLOBAL const U8 reg_main_scene_fallcolor_60hz[][2]
#if defined(_CAMACQ_API_C_)
={
...
{0x03, 0x20},
{0x10, 0x0c}, //60hz [Ltn_check : SCN_Fall_1/4]
{0x2e, 0x33},
...
{0x88, 0x05},
{0x89, 0xb8}, //60hz [Ltn_check : SCN_Fall_2/4]
{0x8a, 0xd8}, //60hz [Ltn_check : SCN_Fall_3/4]
...
{0xfe, 0x05},
{0x10, 0x8c}, //60hz [Ltn_check : SCN_Fall_4/4]
...
// CAMERA_SCENE_INDOOR // == PARTY
//==========================================================
GLOBAL const U8 reg_main_scene_indoor_60hz[][2]
#if defined(_CAMACQ_API_C_)
={
/* CAMERA_SCENEMODE_AGAINST   : Àå\u017e?\u017eðµ?*/
        ...
        {0x03, 0x20},
        {0x10, 0x0c}, //60hz [Ltn_check : SCN_Indoor_1/4]
        {0x2e, 0x13},
        ...
        {0x88, 0x05},
        {0x89, 0xb8}, //60hz [Ltn_check : SCN_Indoor_2/4]
        {0x8a, 0xd8}, //60hz [Ltn_check : SCN_Indoor_3/4]
        ...
        {0xfe, 0x05},
        {0x10, 0x8c}, //60hz [Ltn_check : SCN_Indoor_4/4]
...
// CAMERA_SCENE_LANDSCAPE
//==========================================================
GLOBAL const U8 reg_main_scene_landscape_60hz[][2]
#if defined(_CAMACQ_API_C_)
={
/* CAMERA_SCENEMODE_LANDSCAPE   :*/
	...
	{0x03, 0x00},
        ...
        {0x03, 0x20},
        {0x10, 0x0c}, //60hz [Ltn_check : SCN_Landscape_1/4]
        {0x2e, 0x33},
        ...
        {0x88, 0x05},
        {0x89, 0xb8}, //60hz [Ltn_check : SCN_Landscape_2/4]
        {0x8a, 0xd8}, //60hz [Ltn_check : SCN_Landscape_3/4]
        ...
        {0xfe, 0x05},
        {0x10, 0x8c}, //60hz [Ltn_check : SCN_Landscape_4/4]
...
// CAMERA_SCENE_NIGHT
//==========================================================
GLOBAL const U8 reg_main_scene_night_60hz[][2]
#if defined(_CAMACQ_API_C_)
={
/* CAMERA_SCENEMODE_NIGHT_Nomal */                
  ...
  {0x03, 0x00},
    ...
    {0x03, 0x20},
    {0x10, 0x0c}, //60hz [Ltn_check : SCN_Night_1/4]
    {0x2e, 0x33},
    ...
    {0x88, 0x0f},
    {0x89, 0x42}, //60hz [Ltn_check : SCN_Night_2/4]
    {0x8a, 0x40}, //60hz [Ltn_check : SCN_Night_3/4]
    ...
    {0xfe, 0x05},
    {0x10, 0x8c}, //60hz [Ltn_check : SCN_Night_4/4]
...
GLOBAL const U8 reg_main_scene_night_dark_60hz[][2]
#if defined(_CAMACQ_API_C_)
={
 /* CAMERA_SCENEMODE_NIGHT_Dark */                             
  ...
  {0x03, 0x00},
    ...
    {0x82, 0xff},
     ...
     {0x03, 0x20},                                              
     {0x10, 0x0c}, //60hz [Ltn_check : SCN_Night_Dark_1/6]                                             
     {0x2e, 0x33},                                              
     ...
     {0x83, 0x0f}, /* Dark Condistion  */
     {0x84, 0x42}, //60hz [Ltn_check : SCN_Night_Dark_2/6]                    
     {0x85, 0x40}, //60hz [Ltn_check : SCN_Night_Dark_3/6]                                       
                                                               
     {0x88, 0x0f},                                              
     {0x89, 0x42}, //60hz [Ltn_check : SCN_Night_Dark_4/6]                                               
     {0x8a, 0x40}, //60hz [Ltn_check : SCN_Night_Dark_5/6]                                               
    ...
    {0xb2, 0x90},
     ...
     {0xfe, 0x05},                                              
     {0x10, 0x8c}, //60hz [Ltn_check : SCN_Night_Dark_6/6]                                               
...
// CAMERA_SCENE_SUNRISE
//==========================================================
GLOBAL const U8 reg_main_scene_sunrise_60hz[][2]
#if defined(_CAMACQ_API_C_)
={
...
/* CAMERA_SCENEMODE_SUNRISE   : Àå\u017e?\u017eðµ?  */    
	...
	{0x03, 0X00},                    
        ...
        {0x03, 0X20},
        {0x10, 0X0c}, //60hz [Ltn_check : SCN_Sunrise_1/4]
        {0x2e, 0X33},
        ...
        {0x88, 0X05},
        {0x89, 0Xb8}, //60hz [Ltn_check : SCN_Sunrise_2/4]
        {0x8a, 0Xd8}, //60hz [Ltn_check : SCN_Sunrise_3/4]
        ...
        {0xfe, 0X05},
        {0x10, 0X8c}, //60hz [Ltn_check : SCN_Sunrise_4/4]
...
// CAMERA_SCENE_SUNSET
//==========================================================
GLOBAL const U8 reg_main_scene_sunset_60hz[][2]
#if defined(_CAMACQ_API_C_)
={
...
/* CAMERA_SCENEMODE_SUNSET   : Àå\u017e?\u017eðµ?  */     
        ...
        {0x03, 0x20},            
        {0x10, 0x0c}, //60hz [Ltn_check : SCN_Sunset_1/4]           
        {0x2e, 0x33},            
        ...
        {0x88, 0x05},            
        {0x89, 0xb8}, //60hz [Ltn_check : SCN_Sunset_2/4]            
        {0x8a, 0xd8}, //60hz [Ltn_check : SCN_Sunset_3/4]            
        ...
        {0xfe, 0x05},            
        {0x10, 0x8c}, //60hz [Ltn_check : SCN_Sunset_4/4]            
